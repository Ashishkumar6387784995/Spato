    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <form id="signupForm" method="post" enctype="multipart/form-data">
          ...
          <span id="success_msg" style="color:#44e1d5; font-size:20px;"></span>
          <div class="row pt-3">
            ...
            <div class="col-md-6">
              <div class="details">
                ...
                <div class="inputs">
                  <input class="dynamic-field" type="text" placeholder='#' id="Kategorie_Nr" name="Kategorie_Nr" value="{{$lastCategory}}" readonly />
                  </p>
                </div>
              </div>
