...
<body>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: '/api/suppliersListingApi', // Replace with the actual endpoint URL
                method: 'GET',
                headers: {
                        ...
                        function populateTable(dataList) {
                            ...
                            $.each(dataList, function(index, item) {
                                ...
                                if (data.responseTo === 'Admin') {
                                    row.append(`<td><a href="/api/editSuppliers/admin/${item.id}" class="edit" id="editProductBtn">bearbeiten</a></td>`);
                                }
