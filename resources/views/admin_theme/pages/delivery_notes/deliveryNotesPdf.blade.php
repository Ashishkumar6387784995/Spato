...
<head>
    <title>Delivery Notes PDF</title>
...
<body>
    ...
    <br /><br /><br />
    <h3>Lieferschein Nr. {{$assignments[0]->Auftrags_Nr}}  aus Angebot {{$assignments[0]->Angebot_Nr}}</h3>
    <table class="offers">
        <thead>
            <tr>
                <th>POS</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="height:20px;">{{ $data['Artikel'] }}</td>
