...
<html lang="en">
 ...
 <body>
       ...
       <form action="" id="signupForm">
        <div class="col">
         <div class="row mb-2">
          ...
          <div class="col-6"><input type="file" class="form-control img imageInput" id="Bild_1" name="Bild_1"
         ...
         <div class="row mb-2">
          ...
          <div class="col-6"><input type="file" class="form-control img imageInput" id="Bild_2" name="Bild_2"
            accept=".jpg,.jpeg,.png" onchange="validateFileType()">
           <span class="error" style="font-size:10px; font-weight:600;"></span>
          </div>
         </div>
         <div class="row mb-2">
          ...
          <div class="col-6"><input type="file" class="form-control img imageInput" id="Bild_3" name="Bild_3"
            accept=".jpg,.jpeg,.png" onchange="validateFileType()">
           <span class="error" style="font-size:10px; font-weight:600;"></span>
          </div>
         </div>
         <div class="row mb-2">
          ...
          <div class="col-6"><input type="file" class="form-control img imageInput" id="Bild_4" name="Bild_4"
            accept=".jpg,.jpeg,.png" onchange="validateFileType()">
           <span class="error" style="font-size:10px; font-weight:600;"></span>
          </div>
         </div>
       ...
       <div class="d-flex">
        <div class="mb-3">
         ...
         <span class="d-flex"><input style="width:80%;" class="form-control" type="file" name="ProductsImportFile"><i
           style="position: absolute; left: 30%; top: 26%;" class="fa-solid fa-file-excel"></i></span>
        </div>
        <div class="mb-3">
         <label for="formFile" class="form-label">Import Images file</label>

         <span class="d-flex">
          <input style="width:80%;" class="form-control" type="file" name="ProductsImageFile[]" multiple>
       ...
       <div class="d-flex">
        <div class="mb-3">
         ...
         <span class="d-flex"><input style="width:63%;" class="form-control" type="file" name="ProductsPdfFile[]"
           multiple><i style="position: absolute; left: 30%; top: 70%;" class="fa-solid fa-file-pdf"></i></span>
        </div>
       </div>
      </div>
  ...
  $(document).ready(function() {
   ...
   function displayValidationErrors(errors) {
    // Implement logic to display validation errors in your form
    // You can update this function based on your HTML structure
   }
  });
  </script>
