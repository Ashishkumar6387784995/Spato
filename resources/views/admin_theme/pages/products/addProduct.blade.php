        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <span class="d-flex"><input style="width:50%;" class="form-control" type="file" name="ProductsImportFile" ><i style="position: absolute; left: 30%; top: 45%;" class="fa-solid fa-cloud-arrow-up"></i></span>
            </div>
          </div>
