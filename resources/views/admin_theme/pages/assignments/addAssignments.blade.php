 ...
 <body>
    ...
    <div class="" style="padding-bottom:10px;   margin-top:-1.5rem;">
     ...
     <form id="AddAuftragsForm" method="post">
      <div class="row pt-3">
       ...
       <div class="col-md-2 stretch-card grid-margin">
        <a href="{{url('api/assignmentPdfdownload/'.$newAssignmentNo)}}"><button class="btn" type="button">Rechnung</button></a>
       </div>
       <div class="col-md-2 stretch-card grid-margin">
      ...
      <div class="row pt-3">
       ...
       <div class="col-md-6">
        ...
        <div class="details">
         ...
         <div class="inputs"> 
          <p><input class="dynamic-field " type="text" placeholder='#' id="companyName" name="companyName" onkeyup="guessCompanyNameFunction('Assignments')"></p>
            ...
            <tbody>
              <tr>
                <td>
                    ...
                    <input type="text" class="lastPOS" name='inputs[0][POS]' value="1" id="sno" placeholder='#' /><br>
  ...
  $('#saveButton').click(function(e) {
   ...
   var formData = {
    ...
    Angebots_Nr: $('#AddAuftragsForm input[name="Angebots_Nr"]').val(),
