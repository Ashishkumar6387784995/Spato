...
<body>
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-md-6">
                            <div class="details">
                                ...
                                <div class="inputs">
                                    <input class="dynamic-field" type="text" placeholder='#' id="Auftrags_Nr" name="Auftrags_Nr" value="{{$newAssignmentNo}}" /></p>
                                </div>
                            </div>
    ...
    <script>
        $('#saveButton').click(function(e) {
            ...
            var formData = {
                Auftrags_Nr: $('#AddOffersForm input[name="Auftrags_Nr"]').val(),
