            ...
            <div class="row pt-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="details">
                        ...
                        <div class="inputs">
                            <select id="Ihre_Kundennummer" name="Ihre_Kundennummer" class="showButton" role-filter="Bills" required>
                            </select>
                            <br>
                    ...
                    <div class="details">
                        ...
                        <div class="inputs">
                            <p><input class="dynamic-field " type="text" placeholder='#' id="companyName" name="companyName" onkeyup="guessCompanyNameFunction('Bills')"></p>
