              ...
              <div class="col-12 grid-margin">
                ...
                <div class="row">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="">Our Sub Services</h3>
                         
                                <div class="row mt-4">

                                    @for ($i = 0; $i < count($subCategories); $i++)
                                        <div class="col-md-3 col-sm-8 pe-1"> <a href="{{ url('/subCategories/' . $subCategories[$i]->cId) }}">
                                            <img src=" {{ url($subCategories[$i]->subCImageUrl) }}" class="mb-4 transform-hover"
                                                style="height: 140px; object-fit: cover;" alt="image"></a>
                                            {{-- <img src=" {{ $categories[$i]->imageUrl }}" class="mb-4 transform-hover"
                                    ...
                                    {{-- <div class="col-md-2 col-sm-5 pe-1">
                                        <img src="{{ asset('images/image1.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover; " alt="image">
                                        <img src="{{ asset('images/image2.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                    </div>
                                    <div class="col-md-2 col-sm-5 pe-1">
                                        <img src="{{ asset('images/image3.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                        <img src="{{ asset('images/image4.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                    </div>
                                    <div class="col-md-2  col-sm-5 pe-1">
                                        <img src="{{ asset('images/image5.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                        <img src="{{ asset('images/image6.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                    </div>
                                    <div class="col-md-2   col-sm-5 pe-1">
                                        <img src="{{ asset('images/image7.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                        <img src="{{ asset('images/image8.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                    </div>
                                    <div class="col-md-2   col-sm-5 pe-1">
                                        <img src="{{ asset('images/image9.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                        <img src="{{ asset('images/image10.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                    </div>
                                    <div class="col-md-2  col-sm-5 pe-1">
                                        <img src="{{ asset('images/image11.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                        <img src="{{ asset('images/image12.PNG') }}" class="mb-4 transform-hover"
                                            style="height: 130px; object-fit: cover;" alt="image">
                                    </div> --}}
...
<script type="text/javascript" src="{{ asset('assets/vendors/chart.js/Chart.min.js') }}"></script>
