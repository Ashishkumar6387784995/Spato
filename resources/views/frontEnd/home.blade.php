      ...
      <div class="wrapper">
        ...
        <ul class="carousel">
          ...
          <li class="card">
            ...
            <a href="#" class="btn addToCartButton" data-product-id="{{ $product->id }}" data-quantity="1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
              IN DEN WARENKORB
            </a>
          </li>
          @endforeach
      ...
      <div class="wrapper">
        ...
        <ul class="carousel">
          <li class="card">
            ...
            <a href="#" class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">IN DEN WARENKORB</a>
          </li>
          <li class="card">
            <div class="img"><img src="{{ asset('assets/frontEnd/web/images/product-2.png')}}" alt="img" draggable="false">
            </div>
