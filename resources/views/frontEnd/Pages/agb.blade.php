...
<section class="agb-container">
      <div class="container">
        ...
        <h1 class="text-center">AGB</h1>

        <div class="content">
          <h6>§ 1 Geltung, Begriffsdefinitionen</h6>
          <p class="details">
        ...
        <div class="content">
          <h6>§ 2 Geltung, Begriffsdefinitionen</h6>
          <p class="details">
            Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
            nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam
            erat, sed diam voluptua. At vero eos et accusam et justo duo dolores
        ...
        <div class="content">
          <h6>§ 3 Geltung, Begriffsdefinitionen</h6>
          <p class="details">
            Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
            nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam
            erat, sed diam voluptua. At vero eos et accusam et justo duo dolores
        ...
        <div class="content">
          <h6>§ 4 Geltung, Begriffsdefinitionen</h6>
          <p class="details">
            Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
            nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam
            erat, sed diam voluptua. At vero eos et accusam et justo duo dolores
        ...
        <div class="content">
          <h6>§ 5 Geltung, Begriffsdefinitionen</h6>
          <p class="details">
            Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
            nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam
            erat, sed diam voluptua. At vero eos et accusam et justo duo dolores
