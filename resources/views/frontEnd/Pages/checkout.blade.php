     ...
     <div class="col-8 form">
      ...
      <table class="table">
       ...
       <tbody>
        ...
        <tr class="border-top">
         <td class="item-img"><img src="{{ asset('assets/frontEnd/web/images/p-1.png')}}" class="img" alt="..." />
         </td>
        ...
        <tr class="border-top">
         <td class="item-img"><img src="{{ asset('assets/frontEnd/web/images/p-2.png')}}" class="img" alt="..." />
         </td>
         <td class="product-desc">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam vitae suscipit sequi velit sunt iste
           pariatr error <a href="#">more</a></p>
         </td>
         <td><input type="number" id="price" value="6741.00" step="0.01"
           style="width:80px; border:none; text-align:right; background:transparent;" readonly="readonly"
           oninput="calculateTotal()">€</td>
         <td>
          <div class="counter">
         ...
         <td>€<input type="text" class="input-field" name="" id="subtotal" value="1284.00"
           style="width:80px; border:none; text-align:right; background:transparent;" readonly="readonly"></td>
         <td>
          <div class="icon">
           <i class="fa-regular fa-circle-xmark"></i><br>
         ...
         <div class="accordion" id="accordionExample">
          ...
          <div class="details d-flex justify-content-between">
           ...
           <div class="price-container"><input type="text" class="input-field" name="" id="subtotal" value="13,047.00"
             style="width:150px; border:none; text-align:right;" readonly="readonly">€</div>
          </div>

          <div class="details d-flex justify-content-between">
           <p class="input-field">Shipping </p>
           <div class="price-container"><input type="number" id="shipping" value="21.00" step="0.01"
             style="width:150px; border:none; text-align:right;" readonly="readonly" oninput="calculateTotal()">€</div>
          </div>
          ...
          <div class="details d-flex justify-content-between">
           ...
           <div class="price-container"><input type="text" class="input-field total" name="" id="grandTotal"
             value="13,068.00" style="width:150px; border:none; text-align:right;" readonly="readonly">€</div>
          </div>
