      ...
      <div class="row content">
        <div class="col-8 form">
          ...
          <div class="row address-container">
            ...
            <div class="col-4 address-btn"><button class="change-btn" data-bs-toggle="modal" data-bs-target="#caddress">Change Address</button></div>
          </div>
              ...
              <div class="col">
                <div class="accordion" id="accordionExample">
                  <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <div class="mb-3">
                          <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Enter your destination to get a shipping estimate." rows="3"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="details d-flex justify-content-between">
                    ...
                    <div class="price-container"><input type="text" class="input-field" name="" id="subtotal" value="13,047.00" style="width:150px; border:none; text-align:right;" readonly="readonly">€</div>
                  </div>

                  <div class="details d-flex justify-content-between">
                    <p class="input-field">Shipping </p>
                    <div class="price-container"><input type="number" id="shipping" value="21.00" step="0.01" style="width:150px; border:none; text-align:right;" readonly="readonly" oninput="calculateTotal()">€</div>
                  </div>

                  <div class="details d-flex justify-content-between">
                    <p class="input-field">Tax</p>
                    <div class="price-container"><input type="text" class="input-field" name="" id="tax" value="1.91" style="width:150px; border:none; text-align:right;" readonly="readonly">€</div>
                  </div>

                  <div class="details d-flex justify-content-between">
                    <p class="input-field">Order Total</p>
                    <div class="price-container"><input type="text" class="input-field total" name="" id="grandTotal" value="13,068.00" style="width:150px; border:none; text-align:right;" readonly="readonly">€</div>
                  </div>
  ...
  <script>
    ...
    function displayCartItems(cartItems) {
      ...
      cartItems.forEach(function(item, index) {
        ...
        // Price
        var priceCell = $('<td>€<input type="number" id="price' + index + '" value="' + item.total_price + '" step="0.01" style="width:80px; border:none; text-align:right; background:transparent;" readonly="readonly"></td>');
        tableRow.append(priceCell);

        // Quantity
        var quantityCell = $('<td>');
        quantityCell.append('<div class="counter"><button class="quantity-btn" onclick="decreaseQuantity(' + item.product_id + ')"><i class="fa-solid fa-minus"></i></button> <input type="text" id="quantity' + item.product_id + '" value="' + item.quantity +
        ...
        // Subtotal
        var subtotalCell = $('<td>€<input type="text" class="input-field" id="subtotal' + index + '" value="' + (item.total_price * item.quantity) + '" style="width:80px; border:none; text-align:right; background:transparent;" readonly="readonly"></td>');
        tableRow.append(subtotalCell);

        // Remove and Edit Icons
        var iconCell = $('<td>');
        iconCell.append('<div class="icon" style="cursor:pointer; font-size:18px;"><i class="fa-regular fa-circle-xmark" onclick="removeCartItem(' + item.product_id + ')"></i></div>');
