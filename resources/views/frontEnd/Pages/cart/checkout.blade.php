...
=======
            ...
            <div class="row">
              <div class="col">
                <button type="submit" style="width:100%;" class="change-btn mb-3">Proceed to Pay via <i class="fa-brands fa-paypal"></i></button>
              </div>
>>>>>>> 955a60efeda9c62eb3f31578e48fb200f191c08f
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    function displayAddress(Permanent_address) {
      ...
      $('#develivery_address').text(Permanent_address[0].permanent_address + ',' + Permanent_address[0].zipCode + ',' + Permanent_address[0].country);
