...
=======
      <div class="row address-container">
       ...
       <div class="col-4 address-btn" style="display:flex; justify-content:flex-end;"><button class="change-btn"
         data-bs-toggle="modal" data-bs-target="#caddress">Change Address</button></div>
      </div>
      <div class="table-responsive">
       <table class="table">
        <thead>
...
>>>>>>> 5549a4dcbb1d67eac532380c37515a3e4fb44814
  ...
  function displayCartItems(cartItems) {
   ...
   cartItems.forEach(function(item, index) {
    ...
    // Price
    var priceCell = $('<td><input type="number" id="price' + index + '" value="' + item
     .total_price +
     '" step="0.01" style="width:65px; border:none; outline:none; text-align:right; background:transparent;" readonly="readonly">€</td>'
    );
    tableRow.append(priceCell);
