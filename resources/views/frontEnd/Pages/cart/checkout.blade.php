         ...
         <div class="row content">
           ...
           <div class="col-4 mt-5 mb-5 address">
             <div class="contact-details container">
                 ...
                 <div class="col">
                   <div class="accordion" id="accordionExample">
                     ...
                     <div class="details d-flex justify-content-between">
                       ...
                       <span><input type="text" class="input-field" name="sub_total" id="allSubTotalDisplay" value="00.00" style="width:150px; border:none; text-align:right;" readonly="readonly"><span class="input-field">€</span></span>
                     </div>

                     <div class="details d-flex justify-content-between">
                       <p class="input-field">Shipping </p>
                       <span><input type="number" id="shipping" name="shipping_amt" value="21.00" step="0.01" style="width:150px; border:none; outline:none; text-align:right;" readonly="readonly" oninput="calculateTotal()">€</span>
                     </div>

                     <div class="details d-flex justify-content-between">
                       <p class="input-field">Tax</p>
                       <span><input type="text" class="input-field" name="tax_amt" id="allTaxTotalDisplay" value="1.91" style="width:150px; border:none; text-align:right;" readonly="readonly"><span class="input-field">€</span></span>
                     </div>
               ...
               <div class="row">
                 <div class="col">
                   <button type="submit" style="width:100%;" class="change-btn mb-3" id="orderButton">Proceed to Pay via <i class="fa-brands fa-paypal"></i></button>
                 </div>
               </div>
             </div>
           </div>
   ...
   <script>
     ...
     function displayCartItems(cartItems) {
       ...
       cartItems.forEach(function(item, index) {
         ...
         // Quantity
         var quantityCell = $('<td>');
         quantityCell.append('<div class="counter"><button type="button" class="quantity-btn" onclick="decreaseQuantity(' +
           item
           .product_id +
           ')"><i class="fa-solid fa-minus"></i></button> <input type="text" name="product_quanty[]" id="quantity' + item
           .product_id + '" value="' + item.quantity +
           '" min="1" readonly /> <button type="button" class="quantity-btn" onclick="increaseQuantity(' + item
           .product_id +
     ...
     function displayAddress(Permanent_address) {
       ...
       $('#delv_address').val(Permanent_address[0].permanent_address + ',' + Permanent_address[0].zipCode + ',' +
         Permanent_address[0].country);
     }
       ...
       function displayTempAddress(userTempAddsress) {
         ...
         userTempAddsress.forEach(function(item, index) {
           ...
           if (item.company_name) {
             addressString = '<b>' + item.company_name + '</b>,<br> ' + item.permanent_address + ', ' + item.zipCode + ', ' + item.country;
           } else {
             addressString = item.permanent_address + ', ' + item.zipCode + ', ' + item.country;
           }
       ...
       $.ajax({
         ...
         success: function(response) {
           ...
           if (response.status == '0') {
             $('#cart-items-table-body').html('<tr><td colspan="6" style="color: red;text-align: center;">' + response
               .message + '</td></tr>');
           }
         },
         error: function(error) {
