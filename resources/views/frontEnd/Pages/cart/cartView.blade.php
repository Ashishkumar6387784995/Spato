...
<body oncontextmenu="return false" class="snippet-body">
                            ...
                            <div class="col">
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="details d-flex justify-content-between">
                                        ...
                                        €<input type="text" class="input-field" name="" id="subto" value="13,047.00" style="width:150px; border:none; text-align:right;" readonly="readonly">
                                    </div>

                                    <div class="details d-flex justify-content-between">
                                        <p class="input-field">Shipping </p>
                                        €<input type="number" id="shipping" value="21.00" step="0.01" style="width:150px; border:none; text-align:right;" readonly="readonly" oninput="calculateTotal()">
                                    </div>

                                    <div class="details d-flex justify-content-between">
                                        <p class="input-field">Tax</p>
                                        €<input type="text" class="input-field" name="" id="tax" value="1.91" style="width:150px; border:none; text-align:right;" readonly="readonly">
                                    </div>

                                    <div class="details d-flex justify-content-between">
                                        <p class="input-field">Order Total</p>
                                        €<input type="text" class="input-field total" name="" id="grandTotal" value="13,068.00" style="width:150px; border:none; text-align:right;" readonly="readonly">
                                    </div>
    ...
    <script src="https://code.jquery.com/jquery-3.6.4.min.js" integrity="sha256-oP6HI/tT1HqOQZ8dm37LxlA6C9XvRAISzTREpL4MzkE=" crossorigin="anonymous"></script>
...
<script>
    ...
    function displayCartItems(cartItems) {
        ...
        cartItems.forEach(function(item, index) {
            ...
            var quantityCell = $('<td>');
            quantityCell.append('<div class="counter"><button class="quantity-btn" onclick="decreaseQuantity(' + item.product_id + ')"><i class="fa-solid fa-minus"></i></button> <input type="text" class="quantity-input" id="quantity' + item.product_id + '" value="' + item.quantity +
            ...
            var iconCell = $('<td>');
            iconCell.append('<div class="icon"><i class="fa-regular fa-circle-xmark" onclick="removeCartItem(' + item.product_id + ')"></i><br><i class="fa-regular fa-pen-to-square"></i></div>');
