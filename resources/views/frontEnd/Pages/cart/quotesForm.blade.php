      ...
      <div class="col form">
       <div class="row g-3 mb-5">
        ...
        <div class="col" style="display:none">
         ...
         <input type="text" class="form-control" name="product_id" id="product_id" value="{{$product_id}}"
          placeholder="First name" aria-label="First name">

        </div>
        <div class="col">
         <label for="exampleFormControlInput1" class="form-label">Firmenname: <span style="color:red;">*</span></label>
         <input type="text" class="form-control" name="firmName" id="firmName" placeholder="First name"
        ...
        <div class="col">
         ...
         <input type="text" class="form-control" name="contactName" id="contactName" placeholder="Kontaktname"
       ...
       <div class="row g-3 mb-5">
        <div class="col">
         ...
         <input type="email" class="form-control" name="new_email" id="new_email" placeholder="Your Email"
          aria-label="Your Email">
         <span id="new_email_err" style="color:red; "></span>
        </div>
        <div class="col">
         <label for="exampleFormControlInput1" class="form-label">Telefonnummer <span
           style="color:red;">*</span></label>
         <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Telefonnummer"
       ...
       <div class="row g-3 mb-5">
        <div class="col">
         <label for="exampleFormControlInput1" class="form-label">Spare Part Name <span
           style="color:red;">*</span></label>
         <input type="text" class="form-control" name="sparePartName" id="sparePartName" placeholder="Spare Part Name "
          aria-label="Your Email">
        ...
        <div class="col">
         <label for="exampleFormControlInput1" class="form-label">Quote Needed By <span
           style="color:red;">*</span></label>
         <input type="text" class="form-control" name="QuoteNeededBy" id="QuoteNeededBy" placeholder="Quote Needed By "
