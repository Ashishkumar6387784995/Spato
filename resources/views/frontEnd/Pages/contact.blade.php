          ...
          <div class="col-8 form">
            <div class="row g-3 mb-5">
              ...
              <div class="col">
                ...
                <input type="text" class="form-control" name="enquiry_name" id="enquiry_name" placeholder="First name" aria-label="First name">
              ...
              <div class="col">
                ...
                <input type="text" class="form-control" me="enquiry_email" id="enquiry_email" placeholder="Your Email" aria-label="Your Email">
            ...
            <div class="row g-3 mb-5">
              <div class="col">
                ...
                <input type="text" class="form-control" me="enquiry_phone" id="enquiry_phone" placeholder="Your Phone" aria-label="Your Phone">
